...
public class OrganizationExternalAccess{
	...
	/**
	 * Criteria which needs to be met for OrganizationData to be retrieved.
	 */
	private String criteria;	
	
	private EmployeeRight right;
	/**
	 * Flag which indicates if access is available.
	 */
	private boolean isAllowed = false;
	/**
	 * HashSet of organizations to whom data will be exposed to.
	 */
