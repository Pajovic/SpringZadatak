...
public class OrganizationStartupApp implements CommandLineRunner {
	...
	public void run(String... arg0) throws Exception {
		...
		emp.setCreateRight(false);
		emp.setReadRight(true);
		emp.setUpdateRight(false);
		emp.setDeleteRight(false);		
		employeeService.AddNewEmployee(emp);
		...
		EmployeeDataWrapper edw = new EmployeeDataWrapper(1,1,"Elektromotor", 5, 550);
		employeeService.AddNewData(edw);
		edw = new EmployeeDataWrapper(1,1,"Energetski kabel", 8, 100);
		employeeService.AddNewData(edw);
		edw = new EmployeeDataWrapper(1,1,"Osigurac", 120, 20);
		employeeService.AddNewData(edw);
		edw = new EmployeeDataWrapper(1,1,"Kuciste", 20, 200);
		employeeService.AddNewData(edw);
		
		edw = new EmployeeDataWrapper(1,2,"Ves masina", 5, 2000);
		employeeService.AddNewData(edw);
		edw = new EmployeeDataWrapper(1,2,"Bojler", 4, 500);
		employeeService.AddNewData(edw);
		edw = new EmployeeDataWrapper(1,2,"Sporet", 2, 1200);
		employeeService.AddNewData(edw);
		edw = new EmployeeDataWrapper(1,2,"Sudo masina", 7, 800);
		employeeService.AddNewData(edw);
